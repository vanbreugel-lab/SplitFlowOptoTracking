"""
This script was written by Rich Pang and can be found here: https://github.com/rkp8000/wind_tunnel
...
def heading(velocities):
    ...
    return np.transpose([heading_xy - np.pi/2, heading_xz - np.pi/2, heading_xyz- np.pi/2]) #* 180 / np.pi
