...
if __name__ == '__main__':
    ...
    unifying_algo_data.to_parquet(f'../../../../Data/Unifying_Algo_Results/Main/laminar_data_flash_{translation_flag}.parquet')
    ...
    unifying_algo_data = uaa.run_miop_affine_fit_on_trajectories(braid_df,    
                                                                 ...
                                                                 use_cvx_affine=use_cvx_affine,      
                                                                 include_translation=include_translation)
    unifying_algo_data.to_parquet(f'../../../../Data/Unifying_Algo_Results/Main/laminar_data_sham_{translation_flag}.parquet')
