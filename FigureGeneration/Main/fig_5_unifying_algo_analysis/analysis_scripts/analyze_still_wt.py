...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run unifying algorithm analysis on still air WT data.')
    ...
    # Load the data
    hdf_filename =  '../../../../Data/Experimental_Fly_Data/flies_stillair_wt_preprocessed_optotrigger_trimmed.hdf'
    ...
    unifying_algo_data.to_parquet(f'../../../../Data/Unifying_Algo_Results/Main/WT_stillair_data_flash_{translation_flag}.parquet')
    ...
    unifying_algo_data = uaa.run_miop_affine_fit_on_trajectories(braid_df,    
                                                                 ...
                                                                 use_cvx_affine=use_cvx_affine,      
                                                                 include_translation=include_translation)
    unifying_algo_data.to_parquet(f'../../../../Data/Unifying_Algo_Results/Main/WT_stillair_data_sham_{translation_flag}.parquet')
