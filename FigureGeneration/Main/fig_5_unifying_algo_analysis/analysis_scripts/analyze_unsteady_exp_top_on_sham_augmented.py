...
if __name__ == '__main__':
    ...
    top_on_df = pd.read_parquet(str(config.RAW_DATA_DIR / 'flies_splitflow_topon_c1xwt_preprocessed_optotrigger_trimmed_SHAM_AUGMENTED_merged.parquet'))
    ...
    unifying_algo_data.to_parquet(str(config.PREPROCESSED_DATA_DIR / f'unsteady_top_on_data_sham_AUGMENTED_{translation_flag}.parquet'))
