...
if __name__ == '__main__':
    ...
    parquet_filename = str(config.SIMULATED_DATA_DIR / 'cfd_sim_circling_casting_all_wind_conditions_preprocessed.parquet')
    ...
    for sim_exp in sim_exps:
        ...
        unifying_algo_data.to_parquet(str(config.PREPROCESSED_DATA_DIR / ('cfd_sim_' + sim_exp.replace(' ', '_') + f'_{translation_flag}.parquet')))
