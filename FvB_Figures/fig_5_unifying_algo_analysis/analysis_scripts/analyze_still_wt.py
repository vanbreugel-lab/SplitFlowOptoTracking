...
if __name__ == '__main__':
    ...
    # Load the data
    hdf_filename =  '../trajectory_data/flies_stillair_wt_preprocessed_optotrigger_trimmed.hdf'
    ...
    unifying_algo_data.to_parquet(f'../unifying_algo_results/WT_stillair_data_flash_{translation_flag}.parquet')
    ...
    unifying_algo_data = uaa.run_miop_affine_fit_on_trajectories(braid_df,    
                                                                 ...
                                                                 use_cvx_affine=use_cvx_affine,      
                                                                 include_translation=include_translation)
    unifying_algo_data.to_parquet(f'../unifying_algo_results/WT_stillair_data_sham_{translation_flag}.parquet')
